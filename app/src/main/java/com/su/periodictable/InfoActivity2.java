...
public class InfoActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(InfoActivity2.this, "Click Search Icon.", Toast.LENGTH_SHORT).show();
            }
        });
        bar_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(InfoActivity2.this, "Click Setting Icon.", Toast.LENGTH_SHORT).show();
            }
        });
        bar_tittle.setText("Elements' Info");
        String ig3 = String.valueOf(igi);
        webView  = findViewById(R.id.webview);
        webView.loadUrl("https://solaristechservices.github.io/Atomic-Model/html1.html?num="+ig3);
