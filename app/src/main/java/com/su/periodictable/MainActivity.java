...
import com.su.periodictable.fragment.PeriodicTrendFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.m_trend:
                        ...
                        transaction3.commit();
                        bar_tittle.setText("Trends");
                        return true;
                    case R.id.m_calc:
                        Toast.makeText(MainActivity.this, "Molecular Mass Calculator", Toast.LENGTH_SHORT).show();
